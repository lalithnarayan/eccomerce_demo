...
export class HorizontaltopbarComponent implements OnInit, AfterViewInit {
  ...
  menu_options_mapping = [{
    ...
    options: [
      {
        name: 'Flights',
        desc: 'Get Best Fares on Flight Bookings only at SmartBuy',
        url: '',
      },
      {
        name: 'Hotels',
        desc: 'Compare hotel prices and get great deals on your accommodation',
        url: '',
      }
    ]
  }, {
    name: 'Instant Vouchers',
    url: ''
  }, {
    name: 'Privileges',
    url: ''
